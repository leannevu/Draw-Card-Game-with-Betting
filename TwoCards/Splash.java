 ...
 *              CardGameGUI.java GUI used in a maintaining a famous Players
 *              database.
 * Project      Famous Music Players
...
public class Splash extends JWindow
{
    ...
    *~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/  
    public void showSplash()
    {
        ...
        JLabel label = new JLabel (new ImageIcon("src/Cards/Splash.png"));
        JLabel copyrt = new JLabel ("Coppyright, 2021, Two Cards Game", 
                JLabel.CENTER);
        copyrt.setFont(new Font("Sans-Serif", Font.BOLD, 12));
        content.add(label, BorderLayout.CENTER);
        content.add(loading, BorderLayout.SOUTH);
        Color border = new Color(50, 20, 20, 55);
        content.setBorder(BorderFactory.createLineBorder(border, 3));
