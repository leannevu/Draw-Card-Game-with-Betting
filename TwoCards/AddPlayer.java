...
public class AddPlayer extends javax.swing.JDialog {
    private Player newPlayers = null;  //new Player obj are create
    private boolean error = false;
    private String errorMessage = "";//Error message
    private final double MAX_BALANCE = 40000; // Max balance
    private final int MAX_AGE = 140; // Max age
    private final int MIN_AGE = 14; // Min age
    ...
    /**~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
     *<pre>
     * Constructor      AddPlayers()-default constructor
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Cards/Joker2.png"))); // NOI18N
        ...
        inputJPanel.setLayout(new java.awt.GridLayout(3, 2, 5, 5));
        ...
        inputJPanel.add(balanceJTextField);
    ...
    * Description   Event handler to create a new player; provided data inputed
    *               validation.
    ...
    *~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
    private void saveJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveJButtonActionPerformed
         ...
         String playerBalance = balanceJTextField.getText();
         ...
         if (!Validation.isValidName(playerName)){
             errorMessage += "Invalid Player Name \n";
              ...
              nameJTextField.setToolTipText( nameJTextField.getToolTipText()
                       + "--Invalid Player Name") ;
         } else if (!Validation.isInteger(playerAge, 0 , MAX_AGE)){
              errorMessage += "Invalid Age\n";
              balanceJTextField.requestFocus();
              error = true;
              balanceJTextField.setToolTipText( balanceJTextField.getToolTipText()
                       + "--Invalid Age") ;
         }else if (!Validation.isDouble(playerBalance, 0, MAX_BALANCE)){
         ...
         if (!error)  // all input valid
         {
             try{
                ...
                newPlayers = new Player(name, age, balance);
   ...
   /**~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
     ...
     * Description   Event handler for cancel adding a new player: do nothing and
    ...
    *~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
    ...
    private void ageJTextFieldFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_ageJTextFieldFocusLost
        ...
        if (Validation.isInteger(input, 0, MAX_AGE))
    ...
    private void balanceJTextFieldFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_balanceJTextFieldFocusLost
        ...
        if (Validation.isDouble(input, 0 , MAX_BALANCE))
