 ...
 * Description  Class used to display details for name, age, balance of selected
 *              player, which can also display a picture.
...
//        this(this, true); //call default constructor
        ...
        setPicture(imageJLabel, "src/Cards/", name);
        displayInfo();
    ...
    *</pre>
    ...
    public void displayInfo() {
        String output = "Player: " + myPlayer.getName() + "\nAge of player: " +
                myPlayer.getAge() + "\nAvailable money: " + 
                dollars.format(myPlayer.getBalance());
    ...
    private void initComponents() {
        ...
        imageJLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Cards/Joker.jpg"))); // NOI18N
